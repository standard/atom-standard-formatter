...
module.exports = {
  ...
  format: function (options) {
    ...
    this.transformText(text, editor.getPath(), function (e, transformed) {
      if (e) {
  ...
  transformText: function (text, cwd, cb) {
    if (this.style === 'standard') {
      allowUnsafeNewFunction(function () {
        require('standard').lintText(text, {fix: true, cwd: cwd}, function (e, res) {
          if (e) return cb(e)
