...
module.exports = {
  ...
  toggleFormatOnSave: function (editor) {
    const formatOnSave = atom.config.get('standard-formatter.formatOnSave', {scope: editor.getRootScopeDescriptor()})
    atom.config.set('standard-formatter.formatOnSave', !formatOnSave)
  },
