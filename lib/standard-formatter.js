...
module.exports = {
  ...
  setStyle: function () {
    ...
    if (checkStyleDevDependencies) {
      ...
      if (style === 'standard') {
        ...
        this.style = 'semistandard-format'
      } else if (style === 'happiness') {
        this.style = 'happiness-format'
      }
    } else {
      this.style = atom.config.get('standard-formatter.formatter')
    }
  },
  ...
  getPackageConfig: function () {
    ...
    if (this.style === 'semistandard-format') {
      options.root = 'semistandard'
    } else if (this.style === 'happiness-format') {
